...
t_Fecha = r'[:][ ]*["][1\|2][0\|9][0\.9][0\.9][-][0\|1][0\.9][-][01\.31]["]'#yyyy-mm-dd
#t_FechaPrueba = r'[01\.31]'
...
#data = '"empresas": [ {\n"nombre_empresa": "MC Donals", "fundacion": 2025, '#"dirección": { "calle": "Calle Falsa 123", "ciudad": "Springfield", "pais": "USA"},}'

#data = '"empresas": [{\n"nombre": "string",\n"version": "integer", "fecha_contratacion": "1999-12-31" }]'

data = '"fecha_contratacion": "1999-12-31"'
